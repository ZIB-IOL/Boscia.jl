...
# n5-3
# neos-2978193-inde
src = MOI.FileFormats.Model(filename="neos-2978193-inde.mps")
MOI.read_from_file(src, joinpath(@__DIR__, "mps-files/neos-2978193-inde.mps"))
...
@testset "MPS pk1 instance" begin
    x, _, result = Boscia.solve(f, grad!, lmo, verbose=true, print_iter = 1, fw_epsilon = 1e-1, min_node_fw_epsilon = 1e-3, time_limit=2400)
