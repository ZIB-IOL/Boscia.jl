...
function sparse_reg_boscia(seed=1, n=5, full_callback = false; bo_mode)
    limit = 1800
    ...
    if full_callback
        ...
        file_name = joinpath(@__DIR__, "csv/" * bo_mode * "_" * string(n) * "_" *string(seed) * "_" * mode * "_sparse_reg.csv")
