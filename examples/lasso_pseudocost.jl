...
# end
# push!(groups, ((k_int-1)*group_size+1):p)
function build_optimizer(o,p,k,)
...
@testset "Sparse Regression Group" begin
    ...
    x, _, result = Boscia.solve(f, grad!, lmo, branching_strategy=Boscia.PSEUDO_COST(iterations_stable,false, lmo, μ, decision_function),verbose=true, fw_epsilon=1e-3, print_iter=100, time_limit=600)
