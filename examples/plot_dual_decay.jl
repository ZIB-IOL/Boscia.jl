...
function plot_dual_decay(dim, seed)
    ...
    lns2 = ax.plot(decay_factors, time2, label="0.001", color=colors[2], marker=markers[1], markevery=0.5 )
    lns3 = ax.plot(decay_factors, time3, label="0.005", color=colors[4], marker=markers[6], markevery=0.5 )
