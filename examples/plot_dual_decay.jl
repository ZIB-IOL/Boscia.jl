...
function plot_dual_decay(dim, seed)
   ...
   \usepackage{newtxtext}
    ...
    lns1 = ax.plot(decay_factors, time1, label="0.01", color=cb_green_lime, marker=markers[2], markevery=0.5)
    lns3 = ax.plot(decay_factors, time3, label="0.005", color=cb_burgundy, marker=markers[3], markevery=0.5 )
    lns2 = ax.plot(decay_factors, time2, label="0.001", color=cb_salmon_pink, marker=markers[1], markevery=0.5 )
    lns4 = ax.plot(decay_factors, time4, label="0.0001", color=cb_blue, marker=markers[4], markevery=0.5 )
