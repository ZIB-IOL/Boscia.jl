...
function Bonobo.evaluate_node!(tree::Bonobo.BnBTree, node::FrankWolfeNode)
    ...
    @assert is_integer_feasible(tree.root.problem.integer_variables, tree.incumbent_solution.solution) "source: $(tree.incumbent_solution.source) solution is not integer feasible: $(tree.incumbent_solution.solution)"
