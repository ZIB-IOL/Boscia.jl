...
_value_to_print(::HIERARCHY_PSEUDO_COST) = "Hierarchy-Pseudo Cost"
_value_to_print(::LARGEST_GRADIENT) = "Largest Gradient"
_value_to_print(::LARGEST_MOST_INFEASIBLE_GRADIENT) = "Largest most infeasible gradient "