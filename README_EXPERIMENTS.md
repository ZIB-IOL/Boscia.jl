...
sparse_reg(5,23; full_callback=true, bo_mode=mode)

file_name = "csv/boscia_default_sparse_reg_20_1.csv"
...
sparse_reg(5,20,1;full_callback=true,bo_mode="default")
sparse_reg(5,20,1;full_callback=true,bo_mode="no_tightening")
sparse_reg(5,20,1;full_callback=true,bo_mode="local_tightening")
sparse_reg(5,20,1,;full_callback=true,bo_mode="global_tightening")
