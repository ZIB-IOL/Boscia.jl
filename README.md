...
<!-- Previous CI badge attempts (kept for reference):
...
-->
[![CI Build](https://github.com/ZIB-IOL/Boscia.jl/actions/workflows/ci.yml/badge.svg?event=push&branch=main)](https://github.com/ZIB-IOL/Boscia.jl/actions/workflows/ci.yml?query=event%3Apush+branch%3Amain)
