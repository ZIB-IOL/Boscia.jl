...
-->
[![CI Build](https://img.shields.io/github/actions/workflow/status/ZIB-IOL/Boscia.jl/ci-main.yml?branch=main&label=CI)](https://github.com/ZIB-IOL/Boscia.jl/actions/workflows/ci-main.yml)
