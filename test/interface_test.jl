...
@testset "Norm hyperbox" begin
    ...
    x_baseline, _, result =
        Boscia.solve(f, grad!, build_norm_lmo(), 
...
@testset "Norm hyperbox - strong branching" begin
    ...
    x, _, result = Boscia.solve(f, grad!, lmo, settings_bnb=Boscia.settings_bnb(verbose=false, branching_strategy=branching_strategy))
...
@testset "Different FW variants" begin
    ...
    x_blended, _, result_blended =
        Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
        settings_frank_wolfe=Boscia.settings_frank_wolfe(variant=Boscia.BlendedConditionalGradient()))

    lmo = build_model()
    x_bpcg, _, result_bpcg = Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
        settings_frank_wolfe=Boscia.settings_frank_wolfe(variant=Boscia.BlendedPairwiseConditionalGradient()))

    lmo = build_model()
    x_dicg, _, result_dicg =
        Boscia.solve(f, grad!, lmo, 
            settings_bnb=Boscia.settings_bnb(verbose=false),
            settings_frank_wolfe=Boscia.settings_frank_wolfe(variant=Boscia.DecompositionInvariantConditionalGradient(), fw_verbose=false))
...
@testset "Lazification" begin
    ...
    lmo = build_model()
    x_lazy, _, result_lazy = Boscia.solve(f, grad!, lmo, settings_bnb=Boscia.settings_bnb(verbose=false))

    lmo = build_model()
    x_no, _, result_no = Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
        settings_frank_wolfe=Boscia.settings_frank_wolfe(lazy=false))

    lmo = build_model()
    x_mid, _, result_mid = Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
...
@testset "DICG - Lazification" begin
    ...
    lmo = build_model()
    x_lazy, _, result_lazy = Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
    ...
    x_lazy, _, result_lazy =
        Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
        settings_frank_wolfe=Boscia.settings_frank_wolfe(variant=Boscia.DecompositionInvariantConditionalGradient(use_strong_lazy=true)))
...
@testset "DICG - warm_start" begin
    ...
    x_weak_warm_start, _, result_weak_warm_start =
        Boscia.solve(f, grad!, lmo, 
        settings_bnb=Boscia.settings_bnb(verbose=false),
        settings_frank_wolfe=Boscia.settings_frank_wolfe(variant=Boscia.DecompositionInvariantConditionalGradient(use_DICG_warm_start=true)))
    ...
    x_strong_warm_start, _, result_strong_warm_start = Boscia.solve(
        ...
        lmo,
        settings_bnb=Boscia.settings_bnb(verbose=false),
        settings_frank_wolfe=Boscia.settings_frank_wolfe(variant=Boscia.DecompositionInvariantConditionalGradient(use_DICG_warm_start=true, use_strong_warm_start=true)),
    )
